...
public class DisplaySqls {
    ...
    public static final String SELECT_COMMENT = "select reservation_user_comment.id,reservation_info.id ,concat(left(reservation_info.reservation_email,4), '****') as reservation_email, " +
