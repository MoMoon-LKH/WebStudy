...
<div class="container">
        ...
        <div class="infoList">
            <div class="info">
                ...
                <div class="info_content">
                    <div>
                        <span>장소: </span><span id="place"></span>
                    </div>
                    <div>
            ...
            <div class="info">
                ...
                <div class="info_content" id="opening_hours"></div>
            </div>
            <div class="info">
    ...
    <div class="reservation_info">
        ...
        <div class="reservation_val">
            ...
            <span>총 </span><span id="re_total"></span><span>매</span>
        </div>
    </div>
...
<!-------------------- 템플릿 ------------------------->
<script type="myTemplate" id="costTemplate">
